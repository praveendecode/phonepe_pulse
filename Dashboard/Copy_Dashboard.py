                  ...
                  # ______________________________________________________________________________________________________________________________________________________________________________
                    ...
                    with st.sidebar:     # Navbar
                        selected = option_menu(
                                                   ...
                                                   options=['Intro','Transaction Type Analysis',"Mobile Brand Analysis","Location-Wise Analysis",'Time-Based Analysis','GeoPlot Pulse Analysis','Feedback'],
                            ...
                            with col2:
                                ...
                                with col2:
                                    ...
                                    if st.button('Save Comment'):
                                       ...
                                       col1, col2, col3 = st.columns([6, 30, 5])
                                       with col2:
                                ...
                                with col2 :
                                        if st.button("Click Me!"):
                                            ...
                                            # col2.write("")
                                            with col2:
                                                title_text = "<h1 style='color: #33E8D1; font-size: 30px;'>Press 'G' On Keyboard To Explore More Project</h1>"
